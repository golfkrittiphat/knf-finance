...
const MENU_ITEMS = [
  ...
  { name: "ตำหอยดอง (ปลาร้า/ไม่ปลาร้า)", price: 60 },
  { name: "ตำหมูกรอบ", price: 70 },
  { name: "ตำแตง (ปลาร้า/ไม่ปลาร้า)", price: 50 },
  { name: "ตำแตงปู (ปลาร้า/ไม่ปลาร้า)", price: 55 },
  { name: "ตำแตงไทยไข่เค็ม", price: 60 },
  { name: "ตำแตงไทยปูไข่เค็ม", price: 65 },
  { name: "ตำข้าวโพด", price: 50 },
  { name: "ตำข้าวโพดไข่เค็ม", price: 60 },
  { name: "ตำข้าวโพดกุ้ง", price: 70 },
  { name: "ตำข้าวโพดกุ้งหมูยอ", price: 70 },
  { name: "ตำกระท้อนไทยปู", price: 60 },
  { name: "ตำกระท้อนปูปลาร้า", price: 65 },
  { name: "ตำกระท้อนปลาร้าหมูยอ", price: 65 },
  { name: "ตำกระท้อนปูปลาร้ากุ้งสด", price: 80 },
  { name: "ตำซั่วปูปลาร้า", price: 60 },
  { name: "ตำซั่วปูปลาร้าหมูยอ", price: 65 },
  { name: "ตำซั่วปูปลาร้ากุ้ง (สด/ลวก)", price: 70 },
  ...
  { name: "ข้าวจาน", price: 10 },
  { name: "ข้าวโถ", price: 60 },
  ...
  { name: "เบียร์", price: 70 },
  { name: "เบียร์ 3 ขวด", price: 200 },

  // ===== เมนูอาหารจานเดียว (แยกไซส์) =====
  { name: "ข้าวผัดหมู เล็ก", price: 50 },
  { name: "ข้าวผัดหมู กลาง", price: 100 },
  { name: "ข้าวผัดหมู ใหญ่", price: 150 },
  { name: "ข้าวผัดไก่ เล็ก", price: 50 },
  { name: "ข้าวผัดไก่ กลาง", price: 100 },
  { name: "ข้าวผัดไก่ ใหญ่", price: 150 },
  { name: "ข้าวผัดทะเล เล็ก", price: 60 },
  { name: "ข้าวผัดทะเล กลาง", price: 120 },
  { name: "ข้าวผัดทะเล ใหญ่", price: 180 },
  { name: "ข้าวผัดรวม เล็ก", price: 60 },
  { name: "ข้าวผัดรวม กลาง", price: 120 },
  { name: "ข้าวผัดรวม ใหญ่", price: 180 },
  { name: "ผัดเครื่องแกงหมู (จานเดียว)", price: 50 },
  { name: "ผัดเครื่องแกงไก่ (จานเดียว)", price: 50 },
  { name: "ผัดเครื่องแกงทะเล (จานเดียว)", price: 60 },
  { name: "ผัดเครื่องแกงรวม (จานเดียว)", price: 60 },
  { name: "ผัดเครื่องแกงหมูกรอบ (จานเดียว)", price: 60 },
  { name: "ผัดเครื่องแกงสะตอหมู (จานเดียว)", price: 60 },
  { name: "ผัดเครื่องแกงสะตอไก่ (จานเดียว)", price: 60 },
  { name: "ผัดเครื่องแกงสะตอทะเล (จานเดียว)", price: 70 },
  { name: "ผัดเครื่องแกงสะตอรวม (จานเดียว)", price: 70 },
  { name: "ผัดเครื่องแกงสะตอหมูกรอบ (จานเดียว)", price: 70 },
  { name: "ผัดกะเพราหมู (จานเดียว)", price: 50 },
  { name: "ผัดกะเพราไก่ (จานเดียว)", price: 50 },
  { name: "ผัดกะเพราทะเล (จานเดียว)", price: 60 },
  { name: "ผัดกะเพรารวม (จานเดียว)", price: 60 },
  { name: "ผัดกะเพราหมูกรอบ (จานเดียว)", price: 60 },
  { name: "ข้าวผัดกะเพราหมูกรอบ (จานเดียว)", price: 60 },
  { name: "ผัดพริกหมู (จานเดียว)", price: 50 },
  { name: "ผัดพริกไก่ (จานเดียว)", price: 50 },
  { name: "ผัดพริกทะเล (จานเดียว)", price: 60 },
  { name: "ผัดพริกรวม (จานเดียว)", price: 60 },
  { name: "ผัดพริกหมูกรอบ (จานเดียว)", price: 60 },
  { name: "ผัดพริกไทยดำหมู (จานเดียว)", price: 50 },
  { name: "ผัดพริกไทยดำไก่ (จานเดียว)", price: 50 },
  { name: "ผัดพริกไทยดำทะเล (จานเดียว)", price: 60 },
  { name: "ผัดพริกไทยดำรวม (จานเดียว)", price: 60 },
  { name: "ผัดพริกไทยหมูกรอบ (จานเดียว)", price: 60 },
  { name: "ผัดคะน้าหมูกรอบ (จานเดียว)", price: 60 },
  { name: "ผัดคื่นฉ่ายปลากะพง (จานเดียว)", price: 70 },
  { name: "ผัดคื่นฉ่ายทะเล (จานเดียว)", price: 70 },
  { name: "ผัดกะปิสะตอหมู (จานเดียว)", price: 60 },
  { name: "ผัดกะปิสะตอไก่ (จานเดียว)", price: 60 },
  { name: "ผัดกะปิสะตอทะเล (จานเดียว)", price: 70 },
  { name: "ผัดกะปิสะตอรวม (จานเดียว)", price: 70 },
  { name: "ผัดฉ่ากุ้ง (จานเดียว)", price: 70 },
  { name: "ผัดฉ่าหมึก (จานเดียว)", price: 70 },
  { name: "ผัดฉ่าทะเล (จานเดียว)", price: 70 },
  { name: "ผัดฉ่าปลา (จานเดียว)", price: 70 },
  { name: "คั่วกลิ้งหมู (จานเดียว)", price: 50 },
  { name: "คั่วกลิ้งไก่ (จานเดียว)", price: 50 },
  { name: "ราดหน้าหมู", price: 50 },
  { name: "ราดหน้าไก่", price: 50 },
  { name: "ราดหน้าทะเล", price: 60 },
  { name: "ราดหน้ารวม", price: 60 },
  { name: "ผัดซีอิ๊วหมู", price: 50 },
  { name: "ผัดซีอิ๊วไก่", price: 50 },
  { name: "ผัดซีอิ๊วทะเล", price: 60 },
  { name: "ผัดซีอิ๊วรวม", price: 60 },
  { name: "สุกี้หมู น้ำ", price: 50 },
  { name: "สุกี้หมู แห้ง", price: 50 },
  { name: "สุกี้ไก่ น้ำ", price: 50 },
  { name: "สุกี้ไก่ แห้ง", price: 50 },
  { name: "สุกี้ทะเล น้ำ", price: 60 },
  { name: "สุกี้ทะเล แห้ง", price: 60 },
  { name: "สุกี้รวม น้ำ", price: 60 },
  { name: "สุกี้รวม แห้ง", price: 60 },
  { name: "ไข่ดาว (เพิ่ม)", price: 10 },
  { name: "ไข่เจียว (เพิ่ม)", price: 10 },

  // ===== เมนูทอด =====
  { name: "ปีกไก่ทอด", price: 60 },
  { name: "ไก่ทอดกระเทียม", price: 60 },
  { name: "เอ็นไก่ทอด", price: 80 },
  { name: "กุ้งชุบแป้งทอด", price: 80 },
  { name: "ทอดมันกุ้ง", price: 80 },
  { name: "กุ้งทอดซอสมะขาม", price: 100 },
  { name: "ปลาหมึกชุบแป้งทอด", price: 80 },
  { name: "ปลาหมึกทอดกระเทียม", price: 80 },
  { name: "หมูทอดกระเทียม", price: 60 },
  { name: "ไส้ตันทอดกระเทียม", price: 70 },
  { name: "ซี่โครงหมูทอดกระเทียม", price: 70 },

  // ===== เมนูต้ม =====
  { name: "โป๊ะแตกทะเล", price: 100 },
  { name: "ต้มยำรวมมิตร น้ำข้น", price: 100 },
  { name: "ต้มยำรวมมิตร น้ำใส", price: 100 },
  { name: "ต้มยำทะเล น้ำข้น", price: 100 },
  { name: "ต้มยำทะเล น้ำใส", price: 100 },
  { name: "ต้มยำกุ้ง น้ำข้น", price: 100 },
  { name: "ต้มยำกุ้ง น้ำใส", price: 100 },
  { name: "ต้มยำปลากะพง น้ำข้น", price: 100 },
  { name: "ต้มยำปลากะพง น้ำใส", price: 100 },
  { name: "ต้มยำตีนไก่", price: 70 },
  { name: "แกงเห็ด (ปลาร้า/ไม่ปลาร้า)", price: 60 },
  { name: "แกงอ่อมหมู", price: 70 },
  { name: "แกงอ่อมไก่", price: 70 },
  { name: "ต้มจืดเต้าหู้หมูสับ", price: 80 },
  { name: "ต้มแซ่บกระดูกหมู", price: 80 },
  { name: "ต้มแซ่บตีนไก่", price: 70 },
  { name: "เล้งแซ่บ", price: 70 },
  { name: "ต้มส้มปลากะพง", price: 100 },
  { name: "ต้มส้มปลาจิตรลดา", price: 80 },

  // ===== เมนูกับข้าว =====
  { name: "ผัดเครื่องแกงหมู (กับข้าว)", price: 70 },
  { name: "ผัดเครื่องแกงไก่ (กับข้าว)", price: 70 },
  { name: "ผัดเครื่องแกงรวม (กับข้าว)", price: 100 },
  { name: "ผัดเครื่องแกงทะเล (กับข้าว)", price: 100 },
  { name: "ผัดเครื่องแกงสะตอหมู (กับข้าว)", price: 80 },
  { name: "ผัดเครื่องแกงสะตอไก่ (กับข้าว)", price: 80 },
  { name: "ผัดเครื่องแกงสะตอรวม (กับข้าว)", price: 100 },
  { name: "ผัดเครื่องแกงสะตอทะเล (กับข้าว)", price: 100 },
  { name: "ผัดเครื่องแกงคะน้าปลากระป๋อง", price: 70 },
  { name: "ผัดเครื่องแกงคะน้าหมูกรอบ", price: 80 },
  { name: "ผัดคะน้าหมูกรอบ (กับข้าว)", price: 80 },
  { name: "ผัดคะน้าน้ำมันหอย", price: 60 },
  { name: "ผัดพริกหมู (กับข้าว)", price: 70 },
  { name: "ผัดพริกไก่ (กับข้าว)", price: 70 },
  { name: "ผัดพริกรวม (กับข้าว)", price: 80 },
  { name: "ผัดพริกทะเล (กับข้าว)", price: 80 },
  { name: "ผัดกะเพราหมู (กับข้าว)", price: 70 },
  { name: "ผัดกะเพราไก่ (กับข้าว)", price: 70 },
  { name: "ผัดกะเพรารวม (กับข้าว)", price: 80 },
  { name: "ผัดกะเพราทะเล (กับข้าว)", price: 80 },
  { name: "คั่วกลิ้งหมู (กับข้าว)", price: 70 },
  { name: "คั่วกลิ้งไก่ (กับข้าว)", price: 70 },
  { name: "สะตอผัดกะปิหมู", price: 80 },
  { name: "สะตอผัดกะปิไก่", price: 80 },
  { name: "สะตอผัดกะปิรวม", price: 100 },
  { name: "สะตอผัดกะปิทะเล", price: 100 },
  { name: "ผัดฉ่ารวมทะเล", price: 100 },
  { name: "ผัดฉ่าปลากะพง", price: 100 },
  { name: "ผัดฉ่ากุ้ง", price: 100 },
  { name: "ผัดฉ่าหมึก", price: 100 },
  { name: "ผัดผงกะหรี่รวมทะเล", price: 100 },
  { name: "ผัดผงกะหรี่ปลากะพง", price: 100 },
  { name: "ผัดผงกะหรี่กุ้ง", price: 100 },
  { name: "ผัดผงกะหรี่หมึก", price: 100 },
  { name: "ผัดคื่นฉ่ายรวมทะเล", price: 100 },
  { name: "ผัดคื่นฉ่ายปลากะพง (กับข้าว)", price: 100 },
  { name: "ผัดคื่นฉ่ายหมึก", price: 100 },
  { name: "ผัดคื่นฉ่ายกุ้ง", price: 100 },
  { name: "ไข่เจียวหมูสับ", price: 70 },
  { name: "ปลาหมึกผัดไข่เค็ม", price: 80 },
  { name: "ผัดผักรวม", price: 80 },
  { name: "ผัดผักทะเล", price: 80 },
  { name: "ผัดผักหมู", price: 80 },
  { name: "ผัดผักไก่", price: 80 },
  { name: "ผัดไหลบัวกุ้ง", price: 80 },
  { name: "กุ้งอบวุ้นเส้น", price: 100 },

  // ===== เมนูแกง =====
  { name: "แกงส้มชะอมกุ้ง", price: 100 },
  { name: "แกงส้มผักรวมกุ้ง", price: 100 },
  { name: "แกงส้มปลากะพงผักรวม", price: 100 },
  { name: "แกงส้มปลากะพงหน่อไม้ดอง", price: 100 },
  { name: "แกงคั่วกะทิหน่อไม้หมู", price: 100 },
  { name: "แกงคั่วกะทิหน่อไม้ไก่", price: 100 },
  { name: "แกงคั่วกะทิหน่อไม้กุ้ง", price: 100 },
  { name: "ฉู่ฉี่ทะเล", price: 100 },
  { name: "ฉู่ฉี่ปลากะพง", price: 100 },
  { name: "แกงพริกหมู", price: 80 },
  { name: "แกงพริกไก่", price: 80 },
  { name: "แกงพริกซี่โครงหมู", price: 80 },

  // ===== เมนูปลา (ราคาตามชนิดปลา) =====
  { name: "ปลาลุยสวน (ปลากะพง)", price: 100 },
  { name: "ปลาลุยสวน (ปลาจิตรลดา)", price: 80 },
  { name: "ปลาราดพริก (ปลากะพง)", price: 100 },
  { name: "ปลาราดพริก (ปลาจิตรลดา)", price: 80 },
  { name: "ปลาทอดน้ำปลา (ปลากะพง)", price: 100 },
  { name: "ปลาทอดน้ำปลา (ปลาจิตรลดา)", price: 80 },
  { name: "ปลาทอดซอสมะขาม (ปลากะพง)", price: 100 },
  { name: "ปลาทอดซอสมะขาม (ปลาจิตรลดา)", price: 80 },
  { name: "ปลาทอดกระเทียม (ปลากะพง)", price: 100 },
  { name: "ปลาทอดกระเทียม (ปลาจิตรลดา)", price: 80 },
  ...
  { name: "แมงพลัดผัดกะทิ", price: 70 },
  { name: "ตำแมงพลัดทอด", price: 70 },
  { name: "แมงพลัดผัดพริกไทยดำ", price: 70 },
  { name: "ผัดเครื่องแกงแมงพลัด", price: 70 },
  { name: "ยำแมงพลัด", price: 70 },
];
...
function App() {
  ...
  const [freshStockDate, setFreshStockDate] = useState(todayStr());
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0f172a", color: "#e2e8f0", fontFamily: "'Sarabun','Noto Sans Thai',sans-serif" }}>
      ...
      {freshStockQtyRequest && (
        <FreshPurchaseModal
          itemName={freshStockQtyRequest.itemName}
          unit={freshStockQtyRequest.unit}
          value={freshStockQtyValue}
          setValue={setFreshStockQtyValue}
          date={freshStockDate}
          setDate={setFreshStockDate}
